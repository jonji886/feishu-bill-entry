...
| 输入 | 类型 | 金额 | 流水说明 | 日期 |
|------|------|------|----------|------|
| `中饭 30元` | 餐食 | 30 | `中饭` | `2026-06-26` |
| `昨晚打车 45` | 停车费及其他交通费 | 45 | `打车` | `2026-06-25` |
| `今天地铁往返5元` | 停车费及其他交通费 | 5 | `地铁往返` | `2026-06-26` |
| `昨天退了外卖 25` | 餐食 | -25 | `退了外卖` | `2026-06-25` |
| `支付宝交电费 200` | 水电费 | 200 | `交电费` | `2026-06-26` |
| `信用卡还房贷 5000` | 房贷 | 5000 | `还房贷` | `2026-06-26` |
